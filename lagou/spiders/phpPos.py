...
class JavaposSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        for i in range(len(lis)):
            ...
            # 职位描述
            info_query="//li[@data-positionname='{0}']//div[@class='list_item_bot']/div[@class='li_b_l']/span/text()".format(name)[0]
